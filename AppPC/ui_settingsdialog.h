...
public:
    ...
    void setupUi(QWidget *SettingsDialog)
    {
        ...
        verticalLayout_2->addWidget(additionalOptionsGroupBox);
    ...
    {
        SettingsDialog->setWindowTitle(QApplication::translate("SettingsDialog", "Serial port settings", 0));
        ...
        PbApply->setText(QApplication::translate("SettingsDialog", "Apply", 0));
    } // retranslateUi
